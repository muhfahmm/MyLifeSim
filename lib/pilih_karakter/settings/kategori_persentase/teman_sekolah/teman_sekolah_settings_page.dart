      ...
      body: ListView(
        ...
        children: [
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Semua teman sekolah berhasil DIAKTIFKAN'),
                ...
                Expanded(
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Semua teman sekolah berhasil DIMATIKAN'),
                          duration: Duration(milliseconds: 900),
          ...
          RelationPercentageGroupCard(
            ...
            relationKey: 'Wali Kelas',
          ),
          RelationPercentageGroupCard(
            title: 'Kepala Sekolah',
            icon: Icons.military_tech,
            iconColor: Colors.indigoAccent,
            relationKey: 'Kepala Sekolah',
          ),
          RelationPercentageGroupCard(
          ...
          RelationPercentageGroupCard(
            title: 'Dosen / Pengajar Universitas',
            icon: Icons.history_edu,
            iconColor: Colors.deepPurpleAccent,
            relationKey: 'Dosen',
          ),
          RelationPercentageGroupCard(
            title: 'Teman Kelas SD (Usia 6 - 11)',
            icon: Icons.child_care,
            iconColor: Colors.lightGreen,
            relationKey: 'Teman SD',
          ),
          RelationPercentageGroupCard(
            title: 'Teman Kelas SMP (Usia 12 - 15)',
            icon: Icons.groups,
            iconColor: Colors.orange,
            relationKey: 'Teman SMP',
          ),
          RelationPercentageGroupCard(
            title: 'Teman Kelas SMA (Usia 16 - 18)',
            icon: Icons.school_outlined,
            iconColor: Colors.deepOrange,
            relationKey: 'Teman SMA',
          ),
          RelationPercentageGroupCard(
            title: 'Teman Kuliah / Universitas (Usia > 18)',
            icon: Icons.workspace_premium,
            iconColor: Colors.purpleAccent,
            relationKey: 'Teman Kuliah',
          ),
        ],
      ),
    );
