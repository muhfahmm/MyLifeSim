      ...
      builder: (context, isInvestasi, _) {
        return ValueListenableBuilder<bool>(
          ...
          builder: (context, isKemewahan, _) {
            final bool isAllUnlocked = isInvestasi && isKemewahan;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Hemat Rp 149.000 (Potongan Spesial)',
                        style: TextStyle(
                          fontSize: 11,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Dapatkan 2 Fitur Sekaligus: Portofolio Investasi Saham/Properti & Barang Kemewahan Super VIP!',
                                style: TextStyle(
                                  fontSize: 11.5,
                                  height: 1.35,
