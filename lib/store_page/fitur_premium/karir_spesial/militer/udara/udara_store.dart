// lib/store_page/fitur_premium/karir_spesial/militer/udara/udara_store.dart

import 'dart:async';
import 'package:flutter/material.dart';

class UdaraStorePage extends StatelessWidget {
  const UdaraStorePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Angkatan Udara ✈️', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.lightBlue.shade800, Colors.blue.shade900],
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.flight_takeoff, size: 56, color: Colors.lightBlue.shade800),
                    ),
                    const SizedBox(height: 16),
                    Text(
                      'Tentara Angkatan Udara (TNI AU)',
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    Text(
                      'Mengamankan wilayah udara nasional dan armada skuad tempur.',
                      style: TextStyle(
                        fontSize: 13,
