// lib/store_page/fitur_premium/karir_spesial/esports/pro_player/pro_player_store.dart

import 'dart:async';
import 'package:flutter/material.dart';
import 'package:mylifesim/pilih_karakter/settings/global_settings.dart';

class ProPlayerStorePage extends StatelessWidget {
  const ProPlayerStorePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pro Player 🎮', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.sports_esports, size: 56, color: Colors.teal.shade800),
                    ),
                    ...
                    Text(
                      'Tunjukkan keahlian gaming tingkat tinggi dan bertanding di kejuaraan E-Sports dunia.',
                      style: TextStyle(
                        fontSize: 13,
