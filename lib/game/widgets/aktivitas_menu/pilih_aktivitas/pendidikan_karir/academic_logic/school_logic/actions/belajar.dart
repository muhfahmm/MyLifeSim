// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/academic_logic/school_logic/actions/belajar.dart
import 'dart:math';
...
class _BelajarActionPageState extends State<BelajarActionPage> {
  ...
  void _lakukanBelajar(String tipe, int intGain, int stressCost) {
    ...
    final int discGain = (finalIntGain / 1.5).ceil();
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Belajar Lebih Giat', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
