// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/atlit_profesional_job_logic/karir_pages/aktivitas_karir_atlet/balap/contract_balap_modals.dart
...
class ContractBalapModal {
  static void showContractOffer(
    ...
    final String teamName = offerData['teamName'] ?? 'Tim Balap';
    final int offeredYears = offerData['offeredYears'] as int? ?? 3;
    final int offeredSalary = offerData['offeredSalary'] as int? ?? 25000;
    ...
    showDialog(
      ...
      builder: (ctx) => PopScope(
        ...
        child: AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.assignment_turned_in, color: Colors.red, size: 28),
              SizedBox(width: 8),
              Expanded(
                child: Text(
                  'Penawaran Kontrak Balap 🏎️',
          ...
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text('Manajemen $teamName resmi menawarkan perpanjangan kontrak!', style: const TextStyle(fontSize: 14)),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('• Durasi Kontrak: $offeredYears Tahun', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                        const SizedBox(height: 4),
                        Text('• Gaji Ditawarkan: ${CurrencySettings.format(offeredSalary)} / tahun', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.red.shade900)),
                      ],
                    ),
                  ),
                ],
