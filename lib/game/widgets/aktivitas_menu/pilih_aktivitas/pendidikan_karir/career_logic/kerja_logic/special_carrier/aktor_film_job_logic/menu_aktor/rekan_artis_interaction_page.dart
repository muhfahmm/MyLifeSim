// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/aktor_film_job_logic/menu_aktor/rekan_artis_interaction_page.dart
...
class RekanArtisInteractionPage extends StatefulWidget {
  final Map<String, String> coworker;
  final Character character;
  final VoidCallback onRefresh;

  const RekanArtisInteractionPage({
    super.key,
  ...
  @override
  State<RekanArtisInteractionPage> createState() =>
      _RekanArtisInteractionPageState();
}

class _RekanArtisInteractionPageState
    extends State<RekanArtisInteractionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = widget.coworker['name'] ?? 'Rekan Artis';
    ...
    final int age = int.tryParse(widget.coworker['age'] ?? '25') ?? 25;
    final int rel =
        int.tryParse(widget.coworker['relationship'] ?? '50') ?? 50;
    ...
    final String roleTag = widget.coworker['role'] ?? widget.coworker['title'] ?? 'Aktor / Artis Film';
                    ...
                    if (_isStatsVisible) ...[
                      ...
                      Builder(builder: (context) {
                        ...
                        final String statusText =
                            'Pekerjaan: $roleTag (Gaji: ${CurrencySettings.format(6000)}/bln)';
