// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/atlit_profesional_job_logic/karir_pages/aktivitas_karir_atlet/renang/contract_renang_modals.dart

import 'package:flutter/material.dart';
import 'package:mylifesim/pilih_karakter/character.dart';
import 'package:mylifesim/pilih_karakter/settings/currency_settings.dart';
import 'negosiasi_kontrak_renang_modal.dart';
import 'tim_tertarik_renang_modal.dart';

class ContractRenangModal {
  static void showContractOffer(
    ...
    final String teamName = offerData['teamName'] ?? 'Klub Renang';
    final int offeredYears = offerData['offeredYears'] as int? ?? 3;
    final int offeredSalary = offerData['offeredSalary'] as int? ?? 50000000;
          ...
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'Manajemen $teamName menawarkan kontrak baru!',
            ...
            Row(
              ...
              children: [
                OutlinedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.pop(ctx);
                    NegosiasiKontrakRenangModal.show(
                      context: context,
                      character: character,
                      offerData: offerData,
                      onDone: onDone,
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ...
                    character.inbox.add('📝 Menyutujui kontrak baru di $teamName.');
                    onDone();
                  },
