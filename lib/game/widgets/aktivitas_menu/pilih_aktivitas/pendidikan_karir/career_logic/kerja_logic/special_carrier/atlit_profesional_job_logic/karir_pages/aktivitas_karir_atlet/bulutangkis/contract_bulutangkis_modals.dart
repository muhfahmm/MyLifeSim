// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/atlit_profesional_job_logic/karir_pages/aktivitas_karir_atlet/bulutangkis/contract_bulutangkis_modals.dart
...
class ContractBulutangkisModal {
  static void showContractOffer(
    ...
    final String teamName = offerData['teamName'] ?? 'Klub Bulutangkis';
    ...
    showDialog(
      ...
      builder: (ctx) => PopScope(
        ...
        child: AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.assignment_turned_in, color: Colors.teal, size: 28),
              SizedBox(width: 8),
              Expanded(
                child: Text(
                  'Penawaran Kontrak Bulutangkis 🏸',
