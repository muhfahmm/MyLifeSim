...
class NegosiasiKontrakTinjuMMAModal {
  static void show({
...
class _NegosiasiDialogWidgetState extends State<_NegosiasiDialogWidget> {
  ...
  void _submitNegotiation() {
    ...
    final String teamName = widget.offerData['teamName'] ?? 'Klub Tinju / MMA';
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Icon(Icons.handshake, color: Colors.redAccent, size: 26),
          const SizedBox(width: 8),
          Text('Negosiasi Kontrak Tinju / MMA 🥊', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        ],
      ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(CurrencySettings.format(_demandedSalary), style: TextStyle(fontWeight: FontWeight.bold, color: Colors.redAccent, fontSize: 14)),
              ],
            ),
            Slider(
