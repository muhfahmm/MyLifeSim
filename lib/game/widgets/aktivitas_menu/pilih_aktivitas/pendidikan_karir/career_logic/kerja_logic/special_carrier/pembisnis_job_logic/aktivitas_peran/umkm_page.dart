// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/pembisnis_job_logic/aktivitas_peran/umkm_page.dart
...
class _UmkmPageState extends State<UmkmPage> {
  ...
  void _pantauToko() {
    ...
    _showAlert(
      'Jaga Stand & Layani Pelanggan 🏪',
      'Kamu menyapa pelanggan dengan ramah dan memantau kerapian toko UMKM milikmu!\n\n'
      '• Kedisiplinan Usaha: +$discGain%\n'
      '• Kebahagiaan: +$happyGain%',
    );
  }

  void _promosiWarga() {
    final profitBoost = (character.businessAnnualProfit * 0.05).round() + 50;
    character.businessAnnualProfit += profitBoost;
    setState(() {});
    widget.onRefresh();

    _showAlert(
      'Promosi Brosur & Warga 📣',
      'Kamu membagikan brosur diskon dan posting promosi di media sosial lokal!\n\n'
  ...
  Widget build(BuildContext context) {
    final bool isDark = Theme.of(context).brightness == Brightness.dark;
    final String businessTitle = character.businessName ?? 'Usaha Kecil (UMKM)';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.storefront_rounded, size: 36, color: Colors.green),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Pemilik & Pendiri: ${character.name} 👑',
          ...
          // SEKSI KONTROL & KEBIJAKAN UTAMA
          _buildSectionTitle('Aktivitas Pemilik UMKM 🏪', isDark),
          _buildActionCard(
            context: context,
            title: 'Jaga Stand & Layani Pelanggan',
            desc: 'Tingkatkan kedisiplinan dan kebahagiaan usaha',
            icon: Icons.store,
            color: Colors.green,
            onTap: _pantauToko,
          ),
          _buildActionCard(
            context: context,
            title: 'Promosi Diskon Warga Sekitar',
            desc: 'Sebarkan brosur untuk menambah estimasi profit',
            icon: Icons.campaign,
            color: Colors.orange,
            onTap: _promosiWarga,
          ),
          _buildActionCard(
            context: context,
            title: 'Kelola Tim & Karyawan Usaha',
            desc: 'Interaksi dengan staf bawahan langsung (User sebagai Pemilik)',
            icon: Icons.badge,
            color: Colors.purple,
            onTap: () {
              Navigator.push(
          ...
          _buildActionCard(
            ...
            desc: 'Kelola karyawan, kualitas produk, dan iklan',
            icon: Icons.settings,
          ...
          _buildActionCard(
            ...
            desc: 'Laporan laba rugi, suntik modal, dividen, dan kredit',
          ...
          _buildActionCard(
            ...
            desc: 'Buka cabang kota lain, riset R&D, dan IPO',
