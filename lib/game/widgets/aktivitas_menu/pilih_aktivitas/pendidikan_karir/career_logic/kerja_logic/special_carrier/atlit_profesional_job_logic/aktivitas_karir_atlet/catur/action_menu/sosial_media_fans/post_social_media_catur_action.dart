...
class PostSocialMediaCaturAction {
  static void execute({
    ...
    showResult(
      'Posting Highlight Catur 📲',
      'Mengunggah cuplikan performa Catur di media sosial. Penggemar menyukainya! (+250 Followers & +2 Popularitas).',
      Icons.thumb_up,
      Colors.blueAccent,
    );
  }
