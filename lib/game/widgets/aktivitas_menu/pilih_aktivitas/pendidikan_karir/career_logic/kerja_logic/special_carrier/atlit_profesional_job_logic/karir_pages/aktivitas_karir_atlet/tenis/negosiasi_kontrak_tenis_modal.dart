...
import 'tenis_logic/logika_pemain_tenis.dart';

class NegosiasiKontrakTenisModal {
  static void show({
...
class _NegosiasiDialogWidgetState extends State<_NegosiasiDialogWidget> {
  ...
  void initState() {
    super.initState();
    final validYears = LogikaPemainTenis.getOpsiDurasiKontrak(widget.character.age);
  ...
  void _submitNegotiation() {
    ...
    final String teamName = widget.offerData['teamName'] ?? 'Klub Tenis';
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Icon(Icons.handshake, color: Colors.lightGreen, size: 26),
          const SizedBox(width: 8),
          Text('Negosiasi Kontrak Tenis 🎾', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        ],
      ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(CurrencySettings.format(_demandedSalary), style: TextStyle(fontWeight: FontWeight.bold, color: Colors.lightGreen, fontSize: 14)),
              ],
            ),
            Slider(
