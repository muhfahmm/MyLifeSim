...
class ManajemenOperasionalMenuPage extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.supervisor_account_rounded, size: 64, color: Colors.orange),
                  ),
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Fitur untuk mengelola karyawan, stok inventaris, serta kampanye pemasaran perusahaan akan segera hadir!',
