// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/politikus_job_logic/rekan_politik/rekan_politik_interaction_page.dart
...
class RekanPolitikInteractionPage extends StatefulWidget {
  final Map<String, String> coworker;
  final Character character;
  final VoidCallback onRefresh;

  const RekanPolitikInteractionPage({
    super.key,
  ...
  @override
  State<RekanPolitikInteractionPage> createState() =>
      _RekanPolitikInteractionPageState();
}

class _RekanPolitikInteractionPageState
    extends State<RekanPolitikInteractionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = widget.coworker['name'] ?? 'Kolega Politik';
    ...
    final int age = int.tryParse(widget.coworker['age'] ?? '35') ?? 35;
    final int rel =
        int.tryParse(widget.coworker['relationship'] ?? '50') ?? 50;
    ...
    final String roleTag = widget.coworker['role'] ?? widget.coworker['title'] ?? 'Kolega Politik';
                    ...
                    if (_isStatsVisible) ...[
                      ...
                      Builder(builder: (context) {
                        ...
                        final String statusText =
                            'Pekerjaan: $roleTag (Gaji: ${CurrencySettings.format(4500)}/bln)';
