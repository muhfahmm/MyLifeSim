...
class ContractTenisModal {
  static void showContractOffer(
    ...
    final String teamName = offerData['teamName'] ?? 'Klub Tenis';
    ...
    showDialog(
      ...
      builder: (ctx) => PopScope(
        ...
        child: AlertDialog(
          ...
          title: Row(
            children: [
              Icon(Icons.assignment_turned_in, color: Colors.lightGreen, size: 28),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
                  'Penawaran Kontrak Tenis 🎾',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.lightGreen),
                        ),
                      ],
                    ),
                  ),
