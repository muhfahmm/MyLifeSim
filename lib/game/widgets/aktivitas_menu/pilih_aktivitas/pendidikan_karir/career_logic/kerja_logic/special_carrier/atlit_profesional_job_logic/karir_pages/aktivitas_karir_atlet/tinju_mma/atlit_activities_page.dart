...
import 'action_menu/kontrak_manajemen/negotiate_contract_tinju_mma_action.dart';
import 'action_menu/kontrak_manajemen/consult_agent_tinju_mma_action.dart';

import 'action_menu/pertandingan_statistik/career_history_tinju_mma_modal.dart';

import 'action_menu/sosial_media_fans/press_conference_tinju_mma_action.dart';
...
class AtlitTinjuMMAActivitiesPage extends StatefulWidget {
  ...
  const AtlitTinjuMMAActivitiesPage({
    super.key,
  ...
  @override
  State<AtlitTinjuMMAActivitiesPage> createState() => _AtlitTinjuMMAActivitiesPageState();
}

class _AtlitTinjuMMAActivitiesPageState extends State<AtlitTinjuMMAActivitiesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var item in widget.character.athleteSeasonStats) {
      totalMainStat += (item['kos'] as num?)?.toInt() ?? 0;
    }
    final currentStats = widget.character.currentAthleteStats;
    if (currentStats != null) {
      totalMainStat += (currentStats['kos'] as num?)?.toInt() ?? 0;
    }

    return Scaffold(
      appBar: AppBar(
        title: Text('Menu Karir Atlet Tinju / MMA 🥊'),
      ...
      body: ListView(
        ...
        children: [
          Card(
            elevation: 2,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            color: isDark ? Colors.grey.shade800 : Colors.redAccent.withValues(alpha: 0.1),
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget.character.jobName ?? 'Petarung Utama',
                              style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildStatItem('Kemenangan KO', '$totalMainStat 🥊', Icons.stars, Colors.amber, isDark),
          ...
          _buildCategoryHeader('LATIHAN & KONDISI FISIK', Icons.fitness_center, Colors.redAccent),
          _buildActionCard(
            title: 'Latihan Teknik & Ketajaman 🎯',
            subtitle: 'Melatih fokus dan teknik bertanding Tinju / MMA',
            icon: Icons.sports,
          ...
          _buildCategoryHeader('PERTANDINGAN & STATISTIK', Icons.stadium, Colors.redAccent),
          _buildActionCard(
            title: 'Riwayat Karir & Statistik 📜',
            subtitle: 'Lihat perolehan statistik pertandingan dan performa rating',
            icon: Icons.history,
            color: Colors.purple,
            onTap: () => CareerHistoryTinjuMMAModal.show(
              context: context,
              character: widget.character,
            ),
            isDark: isDark,
          ...
          _buildActionCard(
            ...
            color: Colors.purple,
            onTap: () => NegotiateContractTinjuMMAAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
              showResult: _showResult,
          ...
          _buildActionCard(
            ...
            onTap: () => ConsultAgentTinjuMMAAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
            ),
          ...
          _buildActionCard(
            ...
            icon: Icons.mic,
            color: Colors.blue,
            onTap: () => PressConferenceTinjuMMAAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
              showResult: _showResult,
          ...
          _buildActionCard(
            ...
            onTap: () => PostSocialMediaTinjuMMAAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
              showResult: _showResult,
