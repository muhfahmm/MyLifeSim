...
import 'gaji_pemain_catur.dart';
import 'logika_pemain_catur.dart';

class PerpanjanganKontrakCaturLogic {
  static void evaluasiPerpanjanganKontrak({
    ...
    if (getContractExtension) {
      final validYears = LogikaPemainCatur.getOpsiDurasiKontrak(character.age);
      final int extensionYears = validYears[rand.nextInt(validYears.length)];
      final int currentSalary = character.jobSalary ?? GajiPemainCaturLogic.hitungGajiBerdasarkanUsia(usia: character.age, rand: rand);

      final int offeredSalary = GajiPemainCaturLogic.hitungTawaranGajiBaru(
