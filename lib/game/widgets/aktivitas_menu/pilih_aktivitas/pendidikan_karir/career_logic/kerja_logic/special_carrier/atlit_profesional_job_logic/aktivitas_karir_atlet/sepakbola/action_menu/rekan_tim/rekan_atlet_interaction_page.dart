// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/atlit_profesional_job_logic/aktivitas_karir_atlet/sepakbola/action_menu/rekan_tim/rekan_atlet_interaction_page.dart
...
class RekanAtletInteractionPage extends StatefulWidget {
  final Map<String, String> coworker;
  final Character character;
  final VoidCallback onRefresh;

  const RekanAtletInteractionPage({
    super.key,
  ...
  @override
  State<RekanAtletInteractionPage> createState() =>
      _RekanAtletInteractionPageState();
}

class _RekanAtletInteractionPageState
    extends State<RekanAtletInteractionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = widget.coworker['name'] ?? 'Rekan Atlet';
    ...
    final int age = int.tryParse(widget.coworker['age'] ?? '24') ?? 24;
    final int rel =
        int.tryParse(widget.coworker['relationship'] ?? '50') ?? 50;
    ...
    final String roleTag = widget.coworker['role'] ?? widget.coworker['title'] ?? 'Atlet / Rekan Tim';
                    ...
                    if (_isStatsVisible) ...[
                      ...
                      Builder(builder: (context) {
                        ...
                        final String statusText =
                            'Pekerjaan: $roleTag (Gaji: ${CurrencySettings.format(3500)}/bln)';
