// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/astronot_job_logic/menu_astronot/rekan_astronot_interaction_page.dart
...
class RekanAstronotInteractionPage extends StatefulWidget {
  final Map<String, String> coworker;
  final Character character;
  final VoidCallback onRefresh;

  const RekanAstronotInteractionPage({
    super.key,
  ...
  @override
  State<RekanAstronotInteractionPage> createState() =>
      _RekanAstronotInteractionPageState();
}

class _RekanAstronotInteractionPageState
    extends State<RekanAstronotInteractionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = widget.coworker['name'] ?? 'Rekan Astronot';
    ...
    final int age = int.tryParse(widget.coworker['age'] ?? '32') ?? 32;
    final int rel =
        int.tryParse(widget.coworker['relationship'] ?? '50') ?? 50;
    ...
    final String roleTag = widget.coworker['role'] ?? widget.coworker['title'] ?? 'Astronot / Rekan Skuadron';
                    ...
                    if (_isStatsVisible) ...[
                      ...
                      Builder(builder: (context) {
                        ...
                        final String statusText =
                            'Pekerjaan: $roleTag (Gaji: ${CurrencySettings.format(8000)}/bln)';
