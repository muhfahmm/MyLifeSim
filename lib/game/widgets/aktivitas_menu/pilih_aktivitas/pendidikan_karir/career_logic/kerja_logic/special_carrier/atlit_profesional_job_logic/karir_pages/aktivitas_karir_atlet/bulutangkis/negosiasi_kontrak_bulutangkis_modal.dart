// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/atlit_profesional_job_logic/karir_pages/aktivitas_karir_atlet/bulutangkis/negosiasi_kontrak_bulutangkis_modal.dart
...
class NegosiasiKontrakBulutangkisModal {
  static void show({
...
class _NegosiasiDialogWidgetState extends State<_NegosiasiDialogWidget> {
  ...
  void _submitNegotiation() {
    ...
    final String teamName = widget.offerData['teamName'] ?? 'Klub Bulutangkis';
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: const Row(
        children: [
          Icon(Icons.handshake, color: Colors.teal, size: 26),
          SizedBox(width: 8),
          Text('Negosiasi Kontrak Bulutangkis 🏸', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        ],
      ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(CurrencySettings.format(_demandedSalary), style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.teal, fontSize: 14)),
              ],
            ),
            Slider(
