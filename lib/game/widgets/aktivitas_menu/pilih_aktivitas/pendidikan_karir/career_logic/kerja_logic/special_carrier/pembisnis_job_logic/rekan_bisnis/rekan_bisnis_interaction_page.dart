// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/pembisnis_job_logic/rekan_bisnis/rekan_bisnis_interaction_page.dart
...
class RekanBisnisInteractionPage extends StatefulWidget {
  final Map<String, String> coworker;
  final Character character;
  final VoidCallback onRefresh;

  const RekanBisnisInteractionPage({
    super.key,
  ...
  @override
  State<RekanBisnisInteractionPage> createState() =>
      _RekanBisnisInteractionPageState();
}

class _RekanBisnisInteractionPageState
    extends State<RekanBisnisInteractionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = widget.coworker['name'] ?? 'Mitra Bisnis';
    ...
    final int age = int.tryParse(widget.coworker['age'] ?? '30') ?? 30;
    final int rel =
        int.tryParse(widget.coworker['relationship'] ?? '50') ?? 50;
    ...
    final String roleTag = widget.coworker['role'] ?? widget.coworker['title'] ?? 'Mitra Bisnis';
                    ...
                    if (_isStatsVisible) ...[
                      ...
                      Builder(builder: (context) {
                        ...
                        final String statusText =
                            'Pekerjaan: $roleTag (Gaji: ${CurrencySettings.format(5000)}/bln)';
