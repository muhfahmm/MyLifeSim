...
class ManajemenKeuanganMenuPage extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.account_balance_wallet_rounded, size: 64, color: Colors.green),
                  ),
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Fitur untuk melihat laporan laba rugi, pinjaman modal bank, dividen, dan alokasi anggaran akan segera hadir!',
