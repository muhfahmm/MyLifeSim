...
import 'catur_logic/logika_pemain_catur.dart';

class NegosiasiKontrakCaturModal {
  static void show({
...
class _NegosiasiDialogWidgetState extends State<_NegosiasiDialogWidget> {
  ...
  void initState() {
    super.initState();
    final validYears = LogikaPemainCatur.getOpsiDurasiKontrak(widget.character.age);
  ...
  void _submitNegotiation() {
    ...
    final String teamName = widget.offerData['teamName'] ?? 'Klub Catur';
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Icon(Icons.handshake, color: Colors.deepPurple, size: 26),
          const SizedBox(width: 8),
          Text('Negosiasi Kontrak Catur ♟️', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        ],
      ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(CurrencySettings.format(_demandedSalary), style: TextStyle(fontWeight: FontWeight.bold, color: Colors.deepPurple, fontSize: 14)),
              ],
            ),
            Slider(
