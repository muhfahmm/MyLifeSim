...
import 'gaji_pemain_bulutangkis.dart';
import 'logika_pemain_bulutangkis.dart';

class PerpanjanganKontrakBulutangkisLogic {
  static void evaluasiPerpanjanganKontrak({
    ...
    if (getContractExtension) {
      final validYears = LogikaPemainBulutangkis.getOpsiDurasiKontrak(character.age);
      final int extensionYears = validYears[rand.nextInt(validYears.length)];
      final int currentSalary = character.jobSalary ?? GajiPemainBulutangkisLogic.hitungGajiBerdasarkanUsia(usia: character.age, rand: rand);

      final int offeredSalary = GajiPemainBulutangkisLogic.hitungTawaranGajiBaru(
