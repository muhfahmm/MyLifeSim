...
import 'gaji_pemain_tenis.dart';
import 'logika_pemain_tenis.dart';

class PerpanjanganKontrakTenisLogic {
  static void evaluasiPerpanjanganKontrak({
    ...
    if (getContractExtension) {
      final validYears = LogikaPemainTenis.getOpsiDurasiKontrak(character.age);
      final int extensionYears = validYears[rand.nextInt(validYears.length)];
      final int currentSalary = character.jobSalary ?? GajiPemainTenisLogic.hitungGajiBerdasarkanUsia(usia: character.age, rand: rand);

      final int offeredSalary = GajiPemainTenisLogic.hitungTawaranGajiBaru(
