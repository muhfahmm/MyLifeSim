// lib/game/widgets/aktivitas_menu/pilih_aktivitas/pendidikan_karir/career_logic/kerja_logic/special_carrier/esport_logic/menu_esport/rekan_esport_interaction_page.dart
...
class RekanEsportInteractionPage extends StatefulWidget {
  final Map<String, String> coworker;
  final Character character;
  final VoidCallback onRefresh;

  const RekanEsportInteractionPage({
    super.key,
  ...
  @override
  State<RekanEsportInteractionPage> createState() =>
      _RekanEsportInteractionPageState();
}

class _RekanEsportInteractionPageState
    extends State<RekanEsportInteractionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final name = widget.coworker['name'] ?? 'Rekan Kerja';
    ...
    final int age = int.tryParse(widget.coworker['age'] ?? '20') ?? 20;
    final int rel =
        int.tryParse(widget.coworker['relationship'] ?? '50') ?? 50;
    ...
    final String roleTag = widget.coworker['role'] ?? widget.coworker['title'] ?? 'Rekan Kerja Esport';
                    ...
                    if (_isStatsVisible) ...[
                      ...
                      Builder(builder: (context) {
                        ...
                        final String statusText =
                            'Pekerjaan: $roleTag (Gaji: ${CurrencySettings.format(1800)}/bln)';
                  ...
                  _buildActionTile(
                    ...
                    onTap: () {
                      ...
                      _showOutcome('Keributan 💥',
                          'Kamu terlibat pertengkaran hebat dengan $name di ruang tim!');
                    },
                  ),
                ],
              ),
