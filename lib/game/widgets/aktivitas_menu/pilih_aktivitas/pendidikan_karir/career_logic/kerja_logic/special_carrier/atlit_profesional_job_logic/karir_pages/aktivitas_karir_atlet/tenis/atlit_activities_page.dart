...
import 'action_menu/kontrak_manajemen/negotiate_contract_tenis_action.dart';
import 'action_menu/kontrak_manajemen/consult_agent_tenis_action.dart';

import 'action_menu/pertandingan_statistik/career_history_tenis_modal.dart';

import 'action_menu/sosial_media_fans/press_conference_tenis_action.dart';
...
class AtlitTenisActivitiesPage extends StatefulWidget {
  ...
  const AtlitTenisActivitiesPage({
    super.key,
  ...
  @override
  State<AtlitTenisActivitiesPage> createState() => _AtlitTenisActivitiesPageState();
}

class _AtlitTenisActivitiesPageState extends State<AtlitTenisActivitiesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var item in widget.character.athleteSeasonStats) {
      totalMainStat += (item['grandSlamTitles'] as num?)?.toInt() ?? 0;
    }
    final currentStats = widget.character.currentAthleteStats;
    if (currentStats != null) {
      totalMainStat += (currentStats['grandSlamTitles'] as num?)?.toInt() ?? 0;
    }

    return Scaffold(
      appBar: AppBar(
        title: Text('Menu Karir Atlet Tenis 🎾'),
      ...
      body: ListView(
        ...
        children: [
          Card(
            elevation: 2,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            color: isDark ? Colors.grey.shade800 : Colors.lightGreen.withValues(alpha: 0.1),
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget.character.jobName ?? 'Petenis Utama',
                              style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildStatItem('Grand Slam', '$totalMainStat 🎾', Icons.stars, Colors.amber, isDark),
          ...
          _buildCategoryHeader('LATIHAN & KONDISI FISIK', Icons.fitness_center, Colors.lightGreen),
          _buildActionCard(
            title: 'Latihan Teknik & Ketajaman 🎯',
            subtitle: 'Melatih fokus dan teknik bertanding Tenis',
            icon: Icons.sports,
          ...
          _buildCategoryHeader('PERTANDINGAN & STATISTIK', Icons.stadium, Colors.lightGreen),
          _buildActionCard(
            title: 'Riwayat Karir & Statistik 📜',
            subtitle: 'Lihat perolehan statistik pertandingan dan performa rating',
            icon: Icons.history,
            color: Colors.purple,
            onTap: () => CareerHistoryTenisModal.show(
              context: context,
              character: widget.character,
            ),
            isDark: isDark,
          ...
          _buildActionCard(
            ...
            color: Colors.purple,
            onTap: () => NegotiateContractTenisAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
              showResult: _showResult,
          ...
          _buildActionCard(
            ...
            onTap: () => ConsultAgentTenisAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
            ),
          ...
          _buildActionCard(
            ...
            icon: Icons.mic,
            color: Colors.blue,
            onTap: () => PressConferenceTenisAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
              showResult: _showResult,
          ...
          _buildActionCard(
            ...
            onTap: () => PostSocialMediaTenisAction.execute(
              context: context,
              character: widget.character,
              onRefresh: _triggerRefresh,
              showResult: _showResult,
