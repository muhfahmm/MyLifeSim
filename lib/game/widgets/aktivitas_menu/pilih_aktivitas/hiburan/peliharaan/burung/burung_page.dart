// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/peliharaan/burung/burung_page.dart
import 'dart:math';
...
import 'database_burung.dart';

class BurungPage extends StatefulWidget {
  ...
  @override
  State<BurungPage> createState() => _BurungPageState();
}

class _BurungPageState extends State<BurungPage> {
  static String _fmt(int amount) {
    return CurrencySettings.format(amount);
  }

  static const _names = [
    'Kiwi', 'Rio', 'Blue', 'Pipit', 'Chirpy', 'Sky', 'Sunny', 'Peewee', 'Zazu', 'Iago',
    'Hedwig', 'Fawkes', 'Paulie', 'Nigel', 'Sweetie', 'Angel', 'Birdie', 'Pico', 'Mango', 'Tiki',
    'Coco', 'Pepper', 'Cinnamon', 'Skye', 'Ziggy', 'Echo', 'Phoenix', 'Merlin', 'Orville', 'Wilbur',
    'Ollie', 'Charlie', 'Sammy', 'Buster', 'Lucky', 'Sparky', 'Flash', 'Duster', 'Feathers', 'Tweety',
    'Polly', 'Kiko', 'Taco', 'Nacho', 'Wasabi', 'Milo', 'Leo', 'Jasper', 'Max', 'Buddy',
    'Toby', 'Oscar', 'Felix', 'Rocky', 'Bandit', 'Chester', 'Gus', 'Louie', 'Barnaby', 'Otis',
    'Dexter', 'Gatsby', 'Winston', 'Romeo', 'Juliet', 'Penny', 'Ruby', 'Rosie', 'Poppy', 'Daisy',
    'Olive', 'Stella', 'Lulu', 'Maya', 'Sophie', 'Piper', 'Hazel', 'Willow', 'Zelda', 'Cleo',
    'Princess', 'Honey', 'Sugar', 'Butter', 'Muffin', 'Cookie', 'Cupcake', 'Brownie', 'Pudding', 'Caramel',
    'Marshmallow', 'Waffles', 'Pancake', 'Noodle', 'Tofu', 'Boba', 'Cheeto', 'Salami', 'Biscuit', 'Chirp'
  ];
  ...
  void _executeAdopsi(BuildContext context, Map<String, dynamic> h) {
    ...
    setState(() {
      ...
      widget.character.pets.add({
        ...
        'maxAge': PetLifespanLogic.generateMaxAge('Burung'),
  ...
  Widget build(BuildContext context) {
    ...
    const list = DatabaseBurung.listBurung;

    return Scaffold(
      appBar: AppBar(
        title: const Text('Adopsi Burung 🦜', style: TextStyle(fontWeight: FontWeight.bold)),
