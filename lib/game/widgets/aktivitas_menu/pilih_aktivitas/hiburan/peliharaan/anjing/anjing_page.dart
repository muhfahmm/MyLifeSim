// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/peliharaan/anjing/anjing_page.dart
import 'dart:math';
...
class _AnjingPageState extends State<AnjingPage> {
  ...
  static const _names = [
    'Buddy', 'Max', 'Rocky', 'Bella', 'Charlie', 'Daisy', 'Duke', 'Cooper', 'Bear', 'Teddy',
    'Milo', 'Bentley', 'Zeus', 'Oliver', 'Tucker', 'Jack', 'Leo', 'Loki', 'Winston', 'Murphy',
    'Jax', 'Louie', 'Gus', 'Rover', 'Rex', 'Koda', 'Buster', 'Diesel', 'Bruno', 'Hank',
    'Apollo', 'Sammy', 'Scout', 'Oreo', 'Henry', 'Maverick', 'Zeke', 'Toby', 'Archie', 'Otis',
    'Sam', 'Thor', 'Ollie', 'Jackson', 'Marley', 'Chance', 'Boomer', 'Jasper', 'Benji', 'Prince',
    'Bandit', 'Cody', 'Lucky', 'Rocco', 'King', 'Brody', 'Baxter', 'Frankie', 'Rory', 'Remi',
    'Finn', 'Shadow', 'Simba', 'Copper', 'Moose', 'Barney', 'Tyson', 'Chester', 'Ziggy', 'Hunter',
    'Mac', 'Chico', 'Rusty', 'Joey', 'Peanut', 'Rudy', 'Blue', 'Onyx', 'Cosmo', 'Ace',
    'Titus', 'Cash', 'Gucci', 'Nacho', 'Taco', 'Barkley', 'Waffles', 'Bowie', 'Champ', 'Dash',
    'Dodger', 'Fido', 'Gulliver', 'Hooch', 'Lassie', 'Snoopy', 'Sparky', 'Spike', 'Zorro', 'Buster'
  ];
  ...
  Widget build(BuildContext context) {
    ...
    const list = DatabaseAnjing.listAnjing;

    return Scaffold(
      appBar: AppBar(
        title: const Text('Adopsi Anjing 🐶', style: TextStyle(fontWeight: FontWeight.bold)),
