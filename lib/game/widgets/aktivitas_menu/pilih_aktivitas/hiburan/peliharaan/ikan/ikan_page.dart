// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/peliharaan/ikan/ikan_page.dart
import 'dart:math';
...
class _IkanPageState extends State<IkanPage> {
  ...
  static const _names = [
    'Nemo', 'Bubbles', 'Fin', 'Goldie', 'Splash', 'Blue', 'Dragon', 'Dory', 'Flipper', 'Gill',
    'Jaws', 'Neptune', 'Poseidon', 'Coral', 'Pearl', 'Salty', 'Sunny', 'Wave', 'Ocean', 'Mariner',
    'Captain', 'Comet', 'Flash', 'Ziggy', 'Sparky', 'Glimmer', 'Shine', 'Amber', 'Ruby', 'Sapphire',
    'Emerald', 'Shadow', 'Phantom', 'Ghost', 'Spike', 'Rex', 'Tango', 'Mango', 'Kiwi', 'Wasabi',
    'Sushi', 'Salmon', 'Tuna', 'Tofu', 'Noodle', 'Mochi', 'Boba', 'Pebble', 'Rock', 'Rusty',
    'Copper', 'Silver', 'Gold', 'Bronze', 'Titan', 'Atlas', 'Zeus', 'Apollo', 'Hermes', 'Merlin',
    'Gandalf', 'Casper', 'Cosmo', 'Orbit', 'Nova', 'Star', 'Sky', 'Indigo', 'Teal', 'Aqua',
    'Turquoise', 'Marine', 'River', 'Brook', 'Delta', 'Bay', 'Reef', 'Tide', 'Current', 'Guppy',
    'Betta', 'Tetra', 'Oscar', 'Koko', 'Milo', 'Leo', 'Max', 'Buddy', 'Charlie', 'Sammy',
    'Toby', 'Bandit', 'Chester', 'Otis', 'Dexter', 'Winston', 'Gatsby', 'Flipper', 'Gilligan', 'Finley'
  ];
  ...
  void _executeAdopsi(BuildContext context, Map<String, dynamic> h) {
    ...
    setState(() {
      ...
      widget.character.pets.add({
        ...
        'maxAge': PetLifespanLogic.generateMaxAge('Ikan'),
  ...
  Widget build(BuildContext context) {
    ...
    const list = DatabaseIkan.listIkan;

    return Scaffold(
      appBar: AppBar(
        title: const Text('Adopsi Ikan 🐠', style: TextStyle(fontWeight: FontWeight.bold)),
