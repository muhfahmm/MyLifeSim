// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/berbelanja/mall/gadget_elektronik/gadget_elektronik_page.dart
import 'package:flutter/material.dart';
import 'package:mylifesim/pilih_karakter/character.dart';
import 'package:mylifesim/pilih_karakter/settings/currency_settings.dart';
import 'database_brand.dart';

class GadgetElektronikPage extends StatefulWidget {
  final Character character;
  final VoidCallback onComplete;

  const GadgetElektronikPage({
    super.key,
  ...
  @override
  State<GadgetElektronikPage> createState() => _GadgetElektronikPageState();
}

class _GadgetElektronikPageState extends State<GadgetElektronikPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final brands = GadgetElektronikDatabase.brands;
    final owned = widget.character.ownedShopping.where((e) => e['type'] == 'gadget_elektronik').toList();

    return DefaultTabController(
      length: 2,
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Toko Gadget & Elektronik 📱', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => _GadgetElektronikProductsPage(
                              character: widget.character,
                              brandName: b,
                              products: GadgetElektronikDatabase.products[b] ?? [],
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Belum ada koleksi gadget & elektronik.', style: TextStyle(color: isDark ? Colors.white54 : Colors.grey)),
                        ],
                      ),
                    )
                  : ListView.builder(
...
class _GadgetElektronikProductsPage extends StatefulWidget {
  final Character character;
  final String brandName;
  final List<Map<String, dynamic>> products;
  final VoidCallback onComplete;

  const _GadgetElektronikProductsPage({
    required this.character,
  ...
  @override
  State<_GadgetElektronikProductsPage> createState() => _GadgetElektronikProductsPageState();
}

class _GadgetElektronikProductsPageState extends State<_GadgetElektronikProductsPage> {
  static String _fmt(int amount) => CurrencySettings.format(amount);
