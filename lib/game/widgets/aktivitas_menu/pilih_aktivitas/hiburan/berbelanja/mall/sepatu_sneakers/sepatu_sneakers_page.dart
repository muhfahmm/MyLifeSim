// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/berbelanja/mall/sepatu_sneakers/sepatu_sneakers_page.dart
import 'package:flutter/material.dart';
import 'package:mylifesim/pilih_karakter/character.dart';
import 'package:mylifesim/pilih_karakter/settings/currency_settings.dart';
import 'database_brand.dart';

class SepatuSneakersPage extends StatefulWidget {
  final Character character;
  final VoidCallback onComplete;

  const SepatuSneakersPage({
    super.key,
  ...
  @override
  State<SepatuSneakersPage> createState() => _SepatuSneakersPageState();
}

class _SepatuSneakersPageState extends State<SepatuSneakersPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final brands = SepatuSneakersDatabase.brands;
    final owned = widget.character.ownedShopping.where((e) => e['type'] == 'sepatu_sneakers').toList();

    return DefaultTabController(
      length: 2,
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Toko Sepatu Sneakers 👟', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => _SepatuSneakersProductsPage(
                              character: widget.character,
                              brandName: b,
                              products: SepatuSneakersDatabase.products[b] ?? [],
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Belum ada koleksi sepatu sneakers.', style: TextStyle(color: isDark ? Colors.white54 : Colors.grey)),
                        ],
                      ),
                    )
                  : ListView.builder(
...
class _SepatuSneakersProductsPage extends StatefulWidget {
  final Character character;
  final String brandName;
  final List<Map<String, dynamic>> products;
  final VoidCallback onComplete;

  const _SepatuSneakersProductsPage({
    required this.character,
  ...
  @override
  State<_SepatuSneakersProductsPage> createState() => _SepatuSneakersProductsPageState();
}

class _SepatuSneakersProductsPageState extends State<_SepatuSneakersProductsPage> {
  static String _fmt(int amount) => CurrencySettings.format(amount);
