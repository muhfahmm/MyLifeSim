// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/berbelanja/toko_online/alat_olahraga/alat_olahraga_page.dart
import 'package:flutter/material.dart';
import 'package:mylifesim/pilih_karakter/character.dart';
import 'package:mylifesim/pilih_karakter/settings/currency_settings.dart';
import 'database_brand.dart';

class AlatOlahragaPage extends StatefulWidget {
  final Character character;
  final VoidCallback onComplete;

  const AlatOlahragaPage({
    super.key,
  ...
  @override
  State<AlatOlahragaPage> createState() => _AlatOlahragaPageState();
}

class _AlatOlahragaPageState extends State<AlatOlahragaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final brands = AlatOlahragaDatabase.brands;
    final owned = widget.character.ownedShopping.where((e) => e['type'] == 'alat_olahraga').toList();

    return DefaultTabController(
      length: 2,
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Toko Alat Olahraga 🏋️', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => _AlatOlahragaProductsPage(
                              character: widget.character,
                              brandName: b,
                              products: AlatOlahragaDatabase.products[b] ?? [],
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Belum ada koleksi alat olahraga.', style: TextStyle(color: isDark ? Colors.white54 : Colors.grey)),
                        ],
                      ),
                    )
                  : ListView.builder(
...
class _AlatOlahragaProductsPage extends StatefulWidget {
  final Character character;
  final String brandName;
  final List<Map<String, dynamic>> products;
  final VoidCallback onComplete;

  const _AlatOlahragaProductsPage({
    required this.character,
  ...
  @override
  State<_AlatOlahragaProductsPage> createState() => _AlatOlahragaProductsPageState();
}

class _AlatOlahragaProductsPageState extends State<_AlatOlahragaProductsPage> {
  static String _fmt(int amount) => CurrencySettings.format(amount);
