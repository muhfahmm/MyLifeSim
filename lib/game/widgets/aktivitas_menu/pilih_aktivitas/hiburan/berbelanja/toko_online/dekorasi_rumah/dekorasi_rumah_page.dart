// lib/game/widgets/aktivitas_menu/pilih_aktivitas/hiburan/berbelanja/toko_online/dekorasi_rumah/dekorasi_rumah_page.dart
import 'package:flutter/material.dart';
import 'package:mylifesim/pilih_karakter/character.dart';
import 'package:mylifesim/pilih_karakter/settings/currency_settings.dart';
import 'database_brand.dart';

class DekorasiRumahPage extends StatefulWidget {
  final Character character;
  final VoidCallback onComplete;

  const DekorasiRumahPage({
    super.key,
  ...
  @override
  State<DekorasiRumahPage> createState() => _DekorasiRumahPageState();
}

class _DekorasiRumahPageState extends State<DekorasiRumahPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final brands = DekorasiRumahDatabase.brands;
    final owned = widget.character.ownedShopping.where((e) => e['type'] == 'dekorasi_rumah').toList();

    return DefaultTabController(
      length: 2,
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Toko Dekorasi Rumah 🏠', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                ...
                itemBuilder: (context, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: const Icon(Icons.chair, color: Colors.teal),
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => _DekorasiRumahProductsPage(
                              character: widget.character,
                              brandName: b,
                              products: DekorasiRumahDatabase.products[b] ?? [],
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Belum ada koleksi dekorasi rumah.', style: TextStyle(color: isDark ? Colors.white54 : Colors.grey)),
                        ],
                      ),
                    )
                  : ListView.builder(
...
class _DekorasiRumahProductsPage extends StatefulWidget {
  final Character character;
  final String brandName;
  final List<Map<String, dynamic>> products;
  final VoidCallback onComplete;

  const _DekorasiRumahProductsPage({
    required this.character,
  ...
  @override
  State<_DekorasiRumahProductsPage> createState() => _DekorasiRumahProductsPageState();
}

class _DekorasiRumahProductsPageState extends State<_DekorasiRumahProductsPage> {
  static String _fmt(int amount) => CurrencySettings.format(amount);
