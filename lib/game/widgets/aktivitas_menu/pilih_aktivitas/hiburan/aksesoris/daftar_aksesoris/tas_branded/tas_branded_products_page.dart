...
class TasBrandedProductsPage extends StatefulWidget {
  ...
  @override
  State<TasBrandedProductsPage> createState() => _TasBrandedProductsPageState();
}

class _TasBrandedProductsPageState extends State<TasBrandedProductsPage> {
