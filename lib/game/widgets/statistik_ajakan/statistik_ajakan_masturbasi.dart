...
class StatistikAjakanMasturbasiPage extends StatelessWidget {
  final Character character;

  const StatistikAjakanMasturbasiPage({super.key, required this.character});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Riwayat Ajakan Masturbasi', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                _buildSummaryBadge('Total Diajak', '${historyList.length}x', Colors.purpleAccent),
            ...
            child: historyList.isEmpty
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.clean_hands_outlined, size: 50, color: Colors.grey.shade400),
                        const SizedBox(height: 12),
                        Text(
                          'Belum ada riwayat ajakan masturbasi',
