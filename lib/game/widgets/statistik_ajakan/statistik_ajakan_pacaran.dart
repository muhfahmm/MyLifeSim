...
class StatistikAjakanPacaranPage extends StatelessWidget {
  final Character character;

  const StatistikAjakanPacaranPage({super.key, required this.character});
  ...
  Widget build(BuildContext context) {
    ...
    final historyList = character.proposalHistory.where((item) {
      ...
      return type == 'Ajak Pacaran' || type == 'Pacaran';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Riwayat Ajakan Pacaran', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                _buildSummaryBadge('Total Diajak', '${historyList.length}x', Colors.pinkAccent),
            ...
            child: historyList.isEmpty
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.favorite_border, size: 50, color: Colors.grey.shade400),
                        const SizedBox(height: 12),
                        Text(
                          'Belum ada riwayat ajakan pacaran',
