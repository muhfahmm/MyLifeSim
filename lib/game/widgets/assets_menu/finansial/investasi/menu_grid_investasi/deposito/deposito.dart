...
class DepositoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildCashHeader(state, assetType: 'deposito'),
          Expanded(
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text('Pokok: \$${formatRupiah(d['jumlah'] as num)}'),
                        Text('Bunga: ${d['bunga']}% per tahun'),
                        Text('Bunga terkumpul: \$${formatRupiah(bungaTotal)}'),
                        Text('Total: \$${formatRupiah((d['jumlah'] as num).toDouble() + bungaTotal)}'),
                      ],
                    ),
                  ),
                );
