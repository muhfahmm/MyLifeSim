...
class ReksaDanaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildCashHeader(state, assetType: 'reksa'),
          Expanded(
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Investasi: \$${formatRupiah(state.reksaDanaInvestasi)}'),
                          Text('Return: \$${formatRupiah(state.reksaDanaReturn)}'),
                          const Divider(),
                          Text(
                            'Total: \$${formatRupiah(state.reksaDanaInvestasi + state.reksaDanaReturn)}',
