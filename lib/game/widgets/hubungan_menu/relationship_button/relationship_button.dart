...
class _RelationshipButtonState extends State<RelationshipButton> {
  ...
  void _handleParentingAction(String childName, String action) {
    ...
    // Ambil data anak
    final child = widget.character.children[index];
    int currentRel = int.tryParse(child['relationship'] ?? '80') ?? 80;

    // Ambil gaya asuh saat ini
    if (!widget.character.parentingStyles.containsKey(childName)) {
      widget.character.parentingStyles[childName] = 'Balanced';
    }
    String newStyle = widget.character.parentingStyles[childName]!;
    int relChange = 0;
    ...
    // Simpan perubahan ke dalam data anak
    widget.character.parentingStyles[childName] = newStyle;
    child['relationship'] = (currentRel + relChange).clamp(0, 100).toString();

    // Refresh UI (Halaman Utama dan Dialog)
    widget.onRefresh();
            ...
            builder: (context, setDialogState) {
              ...
              return Column(
                ...
                children: [
                  ...
                  // ============================================
                  // 5. BAGIAN ANAK (JIKA ADA) - DENGAN POPUP MENU
                  // ============================================
  ...
  // --- WIDGET HELPER: Kartu Anak (DENGAN POPUP MENU INTERAKSI) ---
