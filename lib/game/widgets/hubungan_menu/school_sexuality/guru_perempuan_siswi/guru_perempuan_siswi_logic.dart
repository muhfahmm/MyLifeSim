// lib/game/widgets/hubungan_menu/school_sexuality/guru_perempuan_siswi/guru_perempuan_siswi_logic.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:bitlife/pilih_karakter/character.dart';
import 'package:bitlife/game/widgets/dialog_helper.dart';

class GuruPerempuanSiswiLogic {
  static final Random _random = Random();

  /// Peluang dasar pacaran Lesbian: 30%
  static void ajakPacaran({
    ...
    if (accepted) {
      ...
      DialogHelper.show(
        ...
        content: Text('Guru Perempuan $name menerima ajakan pacaran sesama jenismu (Lesbian) secara rahasia!'),
        actions: [
          Builder(
