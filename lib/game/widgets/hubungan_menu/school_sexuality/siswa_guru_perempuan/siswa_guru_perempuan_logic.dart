// lib/game/widgets/hubungan_menu/school_sexuality/siswa_guru_perempuan/siswa_guru_perempuan_logic.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:bitlife/pilih_karakter/character.dart';
import 'package:bitlife/game/widgets/dialog_helper.dart';

class SiswaGuruPerempuanLogic {
  static final Random _random = Random();

  /// Mengajak pacaran (Siswa Laki-laki ke Guru Perempuan)
  /// Peluang dasar: 30% (dari tabel getSchoolRomanceChance)
  static void ajakPacaran({
    ...
    final int successChance = (30 + rel) ~/ 2;
  ...
  /// Bercinta (Siswa Laki-laki ke Guru Perempuan)
