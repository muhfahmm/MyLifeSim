// lib/game/widgets/hubungan_menu/school_sexuality/siswa_siswa/siswa_siswa_logic.dart
import 'dart:math';
import 'package:flutter/material.dart';
import 'package:bitlife/pilih_karakter/character.dart';
import 'package:bitlife/game/widgets/dialog_helper.dart';

class SiswaSiswaLogic {
  static final Random _random = Random();

  /// Mengajak pacaran sesama siswa laki-laki (Gay)
  static void ajakPacaran({
    ...
    final int successChance = (10 + rel) ~/ 2; // Gay base chance: 10%
    ...
    if (accepted) {
      ...
      DialogHelper.show(
        ...
        content: Text('Teman sekelasmu, $name menerima ajakan pacaran sesama jenis (Gay) secara rahasia!'),
        actions: [
          Builder(
