...
class AjakanMlLesbianBaTalent {
  static Map<String, dynamic>? check(Character character, Map<String, dynamic> candidate, Random rand) {
    ...
    if (targetRole == 'CEO') {
      // Peluang ML dengan CEO naik sesuai usia (Lesbian) - sedikit lebih rendah dari hetero
      if (userAge <= 13) chance = 38;
      else if (userAge == 14) chance = 43;
      else if (userAge == 15) chance = 48;
      else if (userAge == 16) chance = 53;
      else if (userAge == 17) chance = 58;
      else chance = 63; // 18+
