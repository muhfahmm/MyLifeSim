...
class AjakanMlGayBaTalent {
  static Map<String, dynamic>? check(Character character, Map<String, dynamic> candidate, Random rand) {
    ...
    if (targetRole == 'CEO') {
      // Peluang ML dengan CEO naik sesuai usia (Gay) - lebih rendah dari hetero
      if (userAge <= 13) chance = 35;
      else if (userAge == 14) chance = 40;
      else if (userAge == 15) chance = 45;
      else if (userAge == 16) chance = 50;
      else if (userAge == 17) chance = 55;
      else chance = 60; // 18+
