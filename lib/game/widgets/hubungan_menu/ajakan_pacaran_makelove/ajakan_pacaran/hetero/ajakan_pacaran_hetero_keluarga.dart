...
class AjakanPacaranHeteroKeluarga {
  static int getChance(Character character, Map<String, dynamic> candidate) {
    ...
    if (myGenderLower == 'perempuan') {
      ...
      else if (rel.contains('anak') || rel == 'laki-laki' || rel == 'perempuan') chance = 60;
      else if (rel.contains('keponakan')) chance = 30;
      else if (rel.contains('paman')) chance = 25;
      else if (rel.contains('ayah')) chance = character.custodyParent == 'Ayah' ? (character.age >= 12 ? 75 : 65) : 40;
